...
const About = () => {
  const aboutStructuredData = {
    ...
    description:
      "Restoran kebab autentik di Indonesia yang didirikan pada tahun 2021. Menyajikan cita rasa asli Lebanon dengan bahan berkualitas halal.",
    ...
    sameAs: ["https://wa.me/6281345383331"],
  };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-4">
                  Sultan Lebanese Kebab didirikan pada tahun 2021 dengan visi
                  untuk menghadirkan cita rasa autentik dengan penuh keyakinan
                  kami menghadirkan rasa yang berbeda dengan kebab lain baik
                  dari jenis kulit kebab yang kami gunakan bahan sayuran yang
                  premium serta di olah secara langsung yang bisa di konsumsi
                  tanpa campuran bahan pengawet. Sehingga disetiap harinya kami
                  hadirkan rasa yang selalu Fress langsung di tangan pelanggan
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <p className="text-lg text-gray-600">
                  Menjadi jaringan restoran kebab terdepan di Indonesia yang
                  dikenal karena kualitas, keaslian rasa, dan pelayanan terbaik,
                  sambil mempertahankan nilai-nilai dalam
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <ul className="text-lg text-gray-600 space-y-2">
                  <li>
                    • Menyajikan makanan berkualitas tinggi dengan bahan halal
                  </li>
                  <li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Komitmen untuk selalu memberikan yang terbaik dalam setiap
                  produk dan layanan
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Menjalankan bisnis dengan jujur, transparan, dan bertanggung
                  jawab
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Terus berinovasi untuk memberikan pengalaman terbaik bagi
                  pelanggan
                </p>
              </div>
            </div>
